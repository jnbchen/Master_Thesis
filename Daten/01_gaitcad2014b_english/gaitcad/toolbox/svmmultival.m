function [ypred,maxi,maxi_all]=svmmultival(x,xsup,w,b,nbsv,kernel,kerneloption)

% USAGE [ypred,maxi,maxi_all]=svmmultival(x,xsup,w,b,nbsv,kernel,kerneloption)
% 
...
%
% Modification: 
% additional output value maxi_all for the sub-classification problems of all class pairs (class c against class not c)
