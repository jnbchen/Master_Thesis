% Script callback_update_plugins
%
% save the commandline selection in the project
%
% The script callback_update_plugins is part of the MATLAB toolbox Gait-CAD. 
...
%restore the commandline selection in the project
