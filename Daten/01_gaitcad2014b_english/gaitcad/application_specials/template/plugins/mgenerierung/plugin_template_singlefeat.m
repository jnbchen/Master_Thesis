  function [datenOut, ret, info] = plugin_template_singlefeat(paras, datenIn)
% function [datenOut, ret, info] = plugin_template_singlefeat(paras, datenIn)
%
% 
% 
...
%
% The function plugin_template_singlefeat is part of the MATLAB toolbox Gait-CAD. 
...
%short description for the new single feature
short_description = 'DOUB MEAN';
%long description for the new single feature
long_description  = 'Doubled mean values';
...
%here, the new single feature will be computed 
datenOut.dat_em =  2 * mean(datenIn.dat,2);
