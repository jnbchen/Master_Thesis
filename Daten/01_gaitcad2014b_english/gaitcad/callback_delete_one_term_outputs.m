% Script callback_delete_one_term_outputs
%
%  Skript callback_delete_one_term_outputs
% 
%  Das Script callback_delete_one_term_outputs ist Teil der MATLAB-Toolbox Gait-CAD. 
...
% 
%
% The script callback_delete_one_term_outputs is part of the MATLAB toolbox Gait-CAD. 
% Copyright (C) 2010  [Ralf Mikut, Tobias Loose, Ole Burmeister, Sebastian Braun, Andreas Bartschat, Johannes Stegmaier, Markus Reischl]
...
ind_ausg = find(max(diff(code_alle)) == 0);
